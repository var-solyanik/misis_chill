![image](https://github.com/user-attachments/assets/092aa6c0-34d1-49e8-a755-5847c89bb171)# Определение факта загрязнения камеры.
---
...
# Основной функционал проекта
    Основной функционал - предсказание маски загрязненной поверхности на линзе с камеры наблюдения. Так же предоставлен код для обучения нейросетевой модели.
---
...
# Струтура проекта 
    ...
    1. *train_dataset/baseline/main.ipynb* - тетрадка для обучения модели
    2. *solution_docker* - докерффайл для запуска инференса модели на данных, которые к сожалению не удастся предоставить(организаторы запретили)
---
